...
import me.alikuxac.vortexia.core.core.storage.cache.IdentityCache;
import me.alikuxac.vortexia.core.core.storage.impl.MySQLStorage;
import me.alikuxac.vortexia.core.core.storage.impl.SQLiteStorage;
...
public class StorageManager implements me.alikuxac.vortexia.api.storage.StorageManager {
  ...
  public java.sql.Connection getConnection() throws java.sql.SQLException {
    if (storage == null) {
      throw new java.sql.SQLException("Storage is not initialized");
    }
  ...
  public String getDatabaseType() {
    ...
    return storage.getDatabaseType();
  }
  ...
  @Override
  public <T> CompletableFuture<T> executeQuery(String sql, me.alikuxac.vortexia.api.storage.SQLFunction<java.sql.ResultSet, T> mapper, Object... params) {
